...
<div class="flex items-center gap-x-2 rounded-lg bg-neutral-300 p-2 shadow-md transition-colors duration-150 hover:bg-neutral-400 dark:bg-neutral-700 dark:hover:bg-neutral-600">
	...
	<div class="flex-grow">
		...
		<div class="mt-1 flex flex-wrap gap-x-1 text-neutral-600 text-xs dark:text-neutral-400">
			{/* Comments */}
			<a
				href={`https://news.ycombinator.com${props.post.permalink}`}
				target="_blank"
				rel="noopener noreferrer"
				onClick={(e) =>
					props.handleLinkClick(
						e,
						`https://news.ycombinator.com${props.post.permalink}`,
					)
				}
			...
			<span class="text-xs">
				...
				<a
					...
					href={`https://news.ycombinator.com/user?id=${props.post.author}`}
					target="_blank"
					rel="noopener noreferrer"
					onClick={(e) =>
						props.handleLinkClick(
							e,
							`https://news.ycombinator.com/user?id=${props.post.author}`,
						)
					}
				>
					{props.post.author}
